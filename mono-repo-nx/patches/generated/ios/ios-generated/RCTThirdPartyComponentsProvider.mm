...
+ (NSDictionary<NSString *, Class<RCTComponentViewProtocol>> *)thirdPartyFabricComponents
{
  ...
  dispatch_once(&nativeComponentsToken, ^{
    thirdPartyComponents = @{
		...
		@"RCTActivityIndicatorView": NSClassFromString(@"RCTActivityIndicatorViewComponentView"), // react-native-macos
		@"RCTDebuggingOverlay": NSClassFromString(@"RCTDebuggingOverlayComponentView"), // react-native-macos
		@"RCTImage": NSClassFromString(@"RCTImageComponentView"), // react-native-macos
		@"RCTInputAccessory": NSClassFromString(@"RCTInputAccessoryComponentView"), // react-native-macos
		@"RCTModalHostView": NSClassFromString(@"RCTModalHostViewComponentView"), // react-native-macos
		@"RCTSafeAreaView": NSClassFromString(@"RCTSafeAreaViewComponentView"), // react-native-macos
		@"RCTPullToRefreshView": NSClassFromString(@"RCTPullToRefreshViewComponentView"), // react-native-macos
		@"RCTScrollView": NSClassFromString(@"RCTScrollViewComponentView"), // react-native-macos
		@"RCTSwitch": NSClassFromString(@"RCTSwitchComponentView"), // react-native-macos
		@"RCTParagraph": NSClassFromString(@"RCTParagraphComponentView"), // react-native-macos
		@"RCTTextInput": NSClassFromString(@"RCTTextInputComponentView"), // react-native-macos
		@"RCTUnimplementedNativeView": NSClassFromString(@"RCTUnimplementedViewComponentView"), // react-native-macos
		@"RCTView": NSClassFromString(@"RCTViewComponentView"), // react-native-macos
    };
  });
